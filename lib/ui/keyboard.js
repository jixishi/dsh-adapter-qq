...
export class KeyboardBuilder {
  ...
  static buildCurrentSessionBoard() {
    const row1 = [
      this.button({ id: 'btn_preset', label: '⚙️ 切换预设', data: '/preset', style: 1 }),
      this.button({ id: 'btn_perm', label: '🛡️ 切换权限', data: '/permission', style: 1 }),
    ];
    const row2 = [
      this.button({ id: 'btn_cancel', label: '🛑 停止执行', data: '/cancel' }),
      this.button({ id: 'btn_list', label: '📋 返回会话列表', data: '/sessions' }),
    ];
